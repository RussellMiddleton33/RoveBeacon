<script lang="ts">
  ...
  let controller: MapLibreYouAreHereController;
  ...
  function init() {
    console.log("MapLibre Init started");

    // Attach maplibregl to window for the SDK to find
    ...
    controller = new MapLibreYouAreHereController({
      markerOptions: {
...
<div class="info-overlay location-info">
  <div class="info-label">Location (MapLibre)</div>
...
{#if showControls}
  <div class="sdk-controls">
    <div class="sdk-header">SDK Controls (MapLibre)</div>
